...
RCT_EXPORT_MODULE(BbdRNFileSystem)
...
{
  BOOL fileExists = [[GDFileManager defaultManager] fileExistsAtPath:filepath];
...
{
  NSError *error = nil;
  NSDictionary *attributes = [[GDFileManager defaultManager] attributesOfItemAtPath:filepath error:&error];
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
  ...
  BOOL success = [[GDFileManager defaultManager] createFileAtPath:filepath contents:data attributes:attributes];
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
  ...
  @try {
    GDFileHandle *fH = [GDFileHandle fileHandleForUpdatingAtPath:filepath];
...
RCT_EXPORT_METHOD(unlink:(NSString*)filepath
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
  GDFileManager *manager = [GDFileManager defaultManager];
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
  ...
  NSData *content = [[GDFileManager defaultManager] contentsAtPath:filepath];
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    ...
    GDFileHandle *file = [GDFileHandle fileHandleForReadingAtPath:filepath];
    if (file == nil) {
...
RCT_EXPORT_METHOD(pathForGroup:(nonnull NSString *)groupId
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
  NSURL *groupURL = [[GDFileManager defaultManager]containerURLForSecurityApplicationGroupIdentifier: groupId];
...
RCT_EXPORT_METHOD(getFSInfo:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
{
  ...
  NSDictionary *dictionary = [[GDFileManager defaultManager] attributesOfFileSystemForPath:[paths lastObject] error:&error];
