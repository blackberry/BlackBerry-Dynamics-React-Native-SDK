 ...
 * from https://github.com/react-native-clipboard/clipboard/tree/v1.11.1/android/src/main/java/com/reactnativecommunity/clipboard
 *
...
public class RNReactNativeBbdClipboardModule extends ReactContextBaseJavaModule {
  ...
  private android.content.ClipboardManager.OnPrimaryClipChangedListener listener = null;
  ...
  public void setListener() {
    try {
      ClipboardManager clipboard = getClipboardService();
      listener = new android.content.ClipboardManager.OnPrimaryClipChangedListener() {
        @Override
