...
import com.blackberry.bbd.reactnative.ui.webview.bbwebview.WebClientObserver;
...
public class GDHttpClientProvider implements WebClientObserver.OnPageFinished, WebClientObserver.OnLoadUrl {
    ...
    private static class ConnectionPool {
        ...
        private final Set<GDHttpClient> httpClientShutdownPool = ConcurrentHashMap.newKeySet();
