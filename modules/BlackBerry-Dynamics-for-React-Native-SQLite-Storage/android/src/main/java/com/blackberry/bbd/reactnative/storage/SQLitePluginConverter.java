...
public abstract class SQLitePluginConverter {
     ...
     * necessary.
     */
    public static String getString(ReadableMap map, String key, String defaultValue) {
        if (map == null){
            return defaultValue;
        }
        try {
     ...
     * necessary.
     */
    public static boolean getBoolean(ReadableMap map, String key, boolean defaultValue) {
        if (map == null){
            return defaultValue;
        }
        try {
     ...
     * necessary.
     */
    public static String getString(ReadableArray array, int index, String defaultValue) {
        if (array == null){
            return defaultValue;
        }
        try {
    ...
    public static Object get(ReadableMap map, String key, Object defaultValue){
        if (map == null){
            return defaultValue;
        }
    ...
    public static Object get(ReadableArray array,int index,Object defaultValue){
        if (array == null){
            return defaultValue;
        }
