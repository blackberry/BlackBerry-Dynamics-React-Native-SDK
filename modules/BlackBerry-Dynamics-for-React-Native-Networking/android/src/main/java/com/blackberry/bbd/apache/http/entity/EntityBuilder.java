...
import com.good.gd.apache.http.entity.SerializableEntity;
 ...
 *   <li>{@link #setParameters(com.good.gd.apache.http.NameValuePair...)}</li>
...
public class EntityBuilder {
     ...
     * {@link #setParameters(com.good.gd.apache.http.NameValuePair...)}
     ...
     * {@link #setParameters(com.good.gd.apache.http.NameValuePair...)} methods.
     */
...
//    }
    ...
    public HttpEntity build() {
        ...
        if (this.text != null) {
            try {
                e = new StringEntity(this.text, getContentOrDefault(ContentType.DEFAULT_TEXT).toString());
            }
            catch (UnsupportedEncodingException th) {
                return null;
            }
        } else if (this.binary != null) {
            e = new ByteArrayEntity(this.binary);
        } else if (this.stream != null) {
            e = new InputStreamEntity(this.stream, -1);
        } else if (this.parameters != null) {
            try {
                e = new UrlEncodedFormEntity(this.parameters,
                        this.contentType != null ? this.contentType.getCharset().toString() : null);
            }
            catch (UnsupportedEncodingException th) {
                return null;
            }
            ...
            e = new FileEntity(this.file, getContentOrDefault(ContentType.DEFAULT_BINARY).toString());
        } else {
            e = new BasicHttpEntity();
        }
        if (e.getContentType() != null && this.contentType != null) {
