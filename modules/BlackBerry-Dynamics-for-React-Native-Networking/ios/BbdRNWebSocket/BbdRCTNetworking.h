...
@protocol BbdRCTNetworkingRequestHandler <NSObject>
...
@protocol BbdRCTNetworkingResponseHandler <NSObject>
...
@interface BbdRCTNetworking : RCTEventEmitter
 ...
 */
- (BbdRCTNetworkTask *)networkTaskWithRequest:(NSURLRequest *)request
...
@interface RCTBridge (BbdRCTNetworking)

@property (nonatomic, readonly) BbdRCTNetworking *bbdNetworkingMobule;
...
extern NSString *const BbdRCTNetworkingPHUploadHackScheme;
