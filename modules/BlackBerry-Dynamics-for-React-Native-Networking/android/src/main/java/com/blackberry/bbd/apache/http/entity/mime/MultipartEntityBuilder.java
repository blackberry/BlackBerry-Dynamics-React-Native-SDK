...
package com.blackberry.bbd.apache.http.entity.mime;
...
import com.blackberry.bbd.apache.http.entity.mime.content.FileBody;
import com.blackberry.bbd.apache.http.entity.mime.content.InputStreamBody;
...
public class MultipartEntityBuilder {
    ...
    private List<NameValuePair> additionalParamsList;
    ...
    public void addParam(final String key, final String value) {
        if (additionalParamsList == null) {
            additionalParamsList = new ArrayList<NameValuePair>();
        }
        additionalParamsList.add(new BasicNameValuePair(key, value));
    }
    ...
    MultipartFormEntity buildEntity() {
        ...
        if (additionalParamsList != null) {
            paramsList.addAll(additionalParamsList);
        }
