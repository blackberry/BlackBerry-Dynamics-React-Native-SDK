...
import static com.blackberry.bbd.reactnative.asyncstorage.ReactDatabaseSupplier.KEY_COLUMN;
import static com.blackberry.bbd.reactnative.asyncstorage.ReactDatabaseSupplier.TABLE_CATALYST;
import static com.blackberry.bbd.reactnative.asyncstorage.ReactDatabaseSupplier.VALUE_COLUMN;
...
public class AsyncLocalStorageUtil {
   ...
   */
  /* package */ public static String buildKeySelection(int selectionCount) {
   ...
   */
  /* package */ public static String[] buildKeySelectionArgs(ReadableArray keys, int start, int count) {
   ...
   */
  /* package */ public static boolean mergeImpl(SQLiteDatabase db, String key, String value)
