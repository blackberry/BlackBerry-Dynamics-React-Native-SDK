...
public class BBWebResourceResponse extends WebResourceResponse {
    ...
    public Map<String, String> getResponseHeaders()
    {
        ...
        try {
            ...
            // Temporary for testing, should be removed
            Header header = response.getFirstHeader("Content-Security-Policy");
            if (header != null) {
                Log.i(TAG,"getResponseHeaders remove header: {" + header.getName() + " : " + header.getValue() + "}");
