 ...
 */
@interface RNReactNativeBbdAsyncStorage : NSObject <RCTBridgeModule,RCTInvalidating>

@property (nonatomic, weak, nullable) id<RNCAsyncStorageDelegateBbd> delegate;
