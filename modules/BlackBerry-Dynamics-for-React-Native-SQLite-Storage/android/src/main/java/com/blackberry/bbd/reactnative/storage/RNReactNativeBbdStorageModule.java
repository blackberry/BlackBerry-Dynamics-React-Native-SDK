...
import com.blackberry.bbd.reactnative.storage.CallbackContext;
import com.blackberry.bbd.reactnative.storage.SQLitePluginConverter;
...
public class RNReactNativeBbdStorageModule extends ReactContextBaseJavaModule {
  ...
  public static final String TAG = RNReactNativeBbdStorageModule.class.getSimpleName();

  private static final String PLUGIN_NAME = "RNReactNativeBbdStorage";
  ...
  public RNReactNativeBbdStorageModule(ReactApplicationContext reactContext) {
    super(reactContext);
