...
export interface NativeCommands {
    ...
    openDownloadsFolder: (viewRef: React.ElementRef<HostComponent<NativeProps>>) => void;
    getDownloadsDirectoryPath: (viewRef: React.ElementRef<HostComponent<NativeProps>>) => void;
}
